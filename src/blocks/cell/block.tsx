...
const Block: React.FC<BlockProps> = ({ _template, markdown, site, path, ...props }) => {
  switch (_template) {
    ...
    case Template.ROW:
      return <Row cols={props.cols} flexAlign={props.flexAlign} flexReverse={props.flexReverse} />;
    case Template.GRID:
      return (
        <Grid cols={props.cols} gutter={props.gutter} lgCol={props.lgCol} mdCol={props.mdCol} smCol={props.smCol} xlCol={props.xlCol} />
      );
